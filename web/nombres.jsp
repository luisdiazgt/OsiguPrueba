	...
	<script type="text/javascript" src="js/jquery-func.js"></script>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                //$.get( "http://localhost:8080/Movie/resources/greeting/get/Movie/Mayra", function( data ) {
                        ...
                        <div id="content">
                                ...
                                <div class="box">
                                        ...
                                        <%            
                                            ...
                                            if(parametro==null || "null".equals(parametro) || parametro.isEmpty())
                                            {
                                                parametro="null";
                                            }
                                            
                                            URL url2 = new URL("http://localhost:8080/Movie/resources/greeting/peliculapornombre/" + parametro);
